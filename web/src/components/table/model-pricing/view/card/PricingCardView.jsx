...
const CARD_STYLES = {
  container:
    'w-12 h-12 cyber-chamfer-sm flex items-center justify-center relative shadow-[var(--box-shadow-neon-sm)] bg-cyber-bg border border-cyber-accent',
  icon: 'w-8 h-8 flex items-center justify-center',
  selected: 'border-cyber-accent bg-cyber-accent/10 shadow-[var(--box-shadow-neon)]',
  default: 'border-cyber-border hover:border-cyber-accent',
};
      ...
      <div className='grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4'>
        {paginatedModels.map((model, index) => {
          ...
          return (
            <Card
              key={modelKey || index}
              className={`transition-all duration-200 hover:shadow-[var(--box-shadow-neon)] border cursor-pointer cyber-chamfer bg-cyber-card ${isSelected ? CARD_STYLES.selected : CARD_STYLES.default}`}
                ...
                <div className='flex items-start justify-between mb-3'>
                  <div className='flex items-start space-x-3 flex-1 min-w-0'>
                    ...
                    <div className='flex-1 min-w-0'>
                      <h3 className='text-lg font-cyber text-cyber-accent tracking-widest uppercase truncate'>
                        {model.model_name}
                      </h3>
                  ...
                  {showRatio && (
                    <div className='pt-3'>
                      <div className='flex items-center space-x-1 mb-2'>
                        ...
                        >
                          <IconHelpCircle
                            className='text-cyber-accent cursor-pointer'
                            size='small'
                            onClick={(e) => {
                              e.stopPropagation();
                      ...
                      <div className='grid grid-cols-3 gap-2 text-xs font-mono text-cyber-text opacity-80'>
                        <div>
                          {t('模型')}:{' '}
