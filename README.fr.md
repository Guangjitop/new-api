...
<p align="center">
  <a href="https://trendshift.io/repositories/20180" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20180" alt="Guangjitop%2Fnew-api | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
  <br>
  <a href="https://hellogithub.com/repository/Guangjitop/new-api" target="_blank">
...
```bash
# Cloner le projet
git clone https://github.com/Guangjitop/new-api.git
cd new-api
...
### 📖 [Documentation officielle](https://docs.newapi.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Guangjitop/new-api)
...
Si les politiques de votre organisation ne permettent pas l'utilisation de logiciels sous licence AGPLv3, ou si vous souhaitez éviter les obligations open-source de l'AGPLv3, veuillez nous contacter à : [your-email@example.com](mailto:your-email@example.com)
...
<sub>Construit avec ❤️ par Guangjitop</sub>
